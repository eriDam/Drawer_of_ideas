...
public class WebLessonsCpp extends ActionBarActivity {
    //Declaro los controles
    WebView wview_lesson;
    final String url = "http://es.cppreference.com/w/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_lessons_cpp);
        //Obtengo los controles
        wview_lesson = (WebView) findViewById(R.id.wview_lesson);
                WebSettings settings = wview_lesson.getSettings();
                settings.setJavaScriptEnabled(true);
                wview_lesson.setWebViewClient(new MyWebViewClient());
                wview_lesson.loadUrl(url);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_web_lessons_js, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_inicio:
                ...
                Intent abre;
                abre = new Intent(WebLessonsCpp.this, MainActivity.class);
                startActivity(abre);
            ...
            case R.id.menu_devtest:
                ...
                //arrancar la siguiente activity
                Intent abreDev;
                abreDev = new Intent(WebLessonsCpp.this, DevTest.class);
            ...
            case R.id.menu_lessons:
                ...
                //arrancar la siguiente activity
                Intent abreLessons;
                abreLessons = new Intent(WebLessonsCpp.this, Lessons2Activity.class);
            ...
            case R.id.menu_profile:
                ...
                //arrancar la siguiente activity
                Intent abreProf;
                abreProf = new Intent(WebLessonsCpp.this, Prof3Activity.class);
            ...
            case R.id.menu_git: /**Este Id  hace referencia al id del item del menu, en este caso buscar*/
                ...
                //arrancar la siguiente activity
                Intent abreGit;
                abreGit = new Intent(WebLessonsCpp.this, OnCode4Activity.class);
            ...
            case R.id.menu_gestion:
                ...
                //arrancar la siguiente activity
                Intent abreGestion;
                abreGestion = new Intent(WebLessonsCpp.this, Gestion5Activity.class);
            ...
            case R.id.menu_blog:
                ...
                //arrancar la siguiente activity
                Intent abreBlog;
                abreBlog = new Intent(WebLessonsCpp.this, Blog6Activity.class);
